...
#define IC746_RFPOWER_METER_CAL { 3, \
    { \
         { 0, 0.0f }, \
         { 143, 0.5f }, \
         { 213, 1.0f } \
...
const struct rig_caps ic746_caps =
{
    ...
    .rfpower_meter_cal = IC746_RFPOWER_METER_CAL,
